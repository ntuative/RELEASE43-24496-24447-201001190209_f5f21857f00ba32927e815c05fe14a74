package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_452:IRoomObjectFactory = null;
      
      private var var_1522:int;
      
      private var var_2281:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         var_450 = [];
         var_451 = [];
         _events.addEventListener(RoomContentLoadedEvent.const_462,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_417,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_633,onContentLoaded);
      }
      
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         var _loc5_:* = null;
         if(_state == const_1321)
         {
            if(var_771 != null)
            {
               return false;
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc19_:IRoomObjectEventHandler = var_452.createRoomObjectLogic(_loc11_);
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_452 = param2 as IRoomObjectFactory;
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(var_452 != null)
         {
            return var_452.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(var_52.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = var_450.indexOf(param1);
            if(_loc2_ >= 0)
            {
               var_450.splice(_loc2_,1);
            }
            if(false)
            {
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = var_452.createRoomObjectLogic(_loc18_);
