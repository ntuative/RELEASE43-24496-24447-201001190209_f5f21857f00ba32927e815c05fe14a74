package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1429:String = "_INCLUDE";
      
      public static const const_936:String = "_EXCLUDE";
      
      public static const const_1446:String = "_TEMP";
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1049,var_1048);
         var_880 = new Dictionary();
         var_1303 = new Dictionary();
         ParamCodeTable.fillTables(var_880,var_1303);
         var_1302 = new Map();
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_880)
            {
               delete var_880[_loc1_];
            }
            for(_loc1_ in var_1303)
            {
               delete var_1303[_loc1_];
            }
            var_1302.dispose();
            var_1302 = null;
            var_29 = null;
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_936) == -1)
                  {
