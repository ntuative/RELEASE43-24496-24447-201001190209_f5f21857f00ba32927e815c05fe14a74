package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IChildEntity, IGraphicContextHost
   {
      ...
      private static var var_1157:uint = 0;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(!var_30)
         {
            var_30 = getGraphicContext(!testParamFlag(WindowParam.const_31));
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_119,WindowParam.const_133);
         var _loc2_:* = !testParamFlag(WindowParam.const_124,WindowParam.const_137);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_22.clone();
            if(_loc1_)
            {
               ...
               {
                  if(var_23.width < _loc3_.width && getParamFlag(WindowParam.const_31))
                  {
                     _loc3_.x = 0;
                  }
                  else
            ...
            if(_loc2_)
            {
               ...
               {
                  if(var_23.height < _loc3_.height && getParamFlag(WindowParam.const_31))
                  {
                     _loc3_.y = 0;
                  }
                  else
      ...
      {
         var_5 = param1;
         var_586 = !!var_5 ? uint(var_586 | var_1315) : uint(var_586 & 16777215);
      ...
      {
         if(_state == WindowState.const_344)
         {
            return true;
         }
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_1833 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_826:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1372:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1313:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_947:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_650:
               _loc2_ = "null";
               break;
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_30)
         {
            var_30 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_728,var_22);
            var_30.visible = var_345;
         }
         return var_30;
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         var_29.invalidate(this,var_22,WindowRedrawFlag.const_872);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_951 || _loc3_.hasGraphicsContext())
         {
      ...
      {
         return !testParamFlag(WindowParam.const_31) || var_30 != null;
      }
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_919;
                  if(testParamFlag(WindowParam.const_309))
                  {
                     _loc5_ = {};
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_215))
                        {
               ...
               case MouseEvent.MOUSE_UP:
                  if(method_3(WindowState.const_88))
                  {
               ...
               case MouseEvent.MOUSE_OUT:
                  if(method_3(WindowState.const_73))
                  {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_238:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_372,this,null));
                     if(testParamFlag(WindowParam.const_169,WindowParam.const_133))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_151,WindowParam.const_137))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_23 != null)
                  ...
                  break;
               case WindowNotifyEvent.const_380:
                  var_29.invalidate(this,var_22.union(var_61),WindowRedrawFlag.const_351);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_966,this,null));
                     if(var_23 != null)
                     {
               ...
               case WindowNotifyEvent.const_274:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_625,this,null));
                     if(var_23 != null)
                     {
                  ...
                  break;
               case WindowNotifyEvent.const_357:
                  var_29.invalidate(this,var_22,WindowRedrawFlag.const_830);
                  break;
               case WindowNotifyEvent.const_429:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_359:
                  if(!(var_31 & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        var_29.invalidate(this,var_22,WindowRedrawFlag.const_351);
                     }
                  }
                  else if(var_31 & 0)
                  {
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_274;
         update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_951 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      {
         return !testParamFlag(WindowParam.const_31) ? getGraphicContext(true).fetchDrawBuffer() : (var_23 != null ? var_23.fetchDrawBuffer() : null);
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1276,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_23 != param1)
         {
            ...
            else
            {
               ...
               var_291.width = 0;
               var_291.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_903,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         _loc2_.var_1315 = var_1315;
         _loc2_.var_1053 = var_1053;
      ...
      public function unlock() : Boolean
      {
         ...
         setStateFlag(WindowState.const_58,false);
         _loc1_.type = WindowNotifyEvent.const_1358;
         update(this,_loc1_);
         return true;
      }
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_650;
         update(this,_loc1_);
         return true;
      }
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_645;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
