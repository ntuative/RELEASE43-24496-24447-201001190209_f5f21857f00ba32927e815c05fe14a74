package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_741:String = "margin_top";
      
      private static const const_1035:String = "_HEADER";
      
      private static const const_739:String = "margin_right";
      
      private static const const_1036:String = "_SCALER";
      
      private static const const_1034:String = "_TITLE";
      
      private static const const_1037:String = "_CONTENT";
      
      private static const const_742:String = "margin_left";
      
      private static const const_740:String = "margin_bottom";
      ...
      private var var_1096:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_742,_loc3_.left,PropertyStruct.const_62,_loc2_));
         _loc1_.push(new PropertyStruct(const_741,_loc3_.top,PropertyStruct.const_62,_loc2_));
         _loc1_.push(new PropertyStruct(const_739,0 - _loc3_.right,PropertyStruct.const_62,_loc2_));
         _loc1_.push(new PropertyStruct(const_740,0 - _loc3_.bottom,PropertyStruct.const_62,_loc2_));
         return _loc1_;
      }
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1096 == null)
         {
            var_1096 = findChildByTag(const_1035) as IHeaderWindow;
            if(!var_1096)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1034) as ITextWindow;
            if(!_title)
            {
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_269,false);
         }
      ...
      public function get content() : IWindowContainer
      {
         if(var_35 == null)
         {
            var_35 = findChildByTag(const_1037) as IWindowContainer;
            if(!var_35)
            {
