package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected var var_504:String = "none";
      
      protected var var_588:Number;
      
      protected var var_362:Number;
      ...
      {
         return new Rectangle(var_588 * maxScrollH,var_362 * maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_face",defaultTextFormat.font,PropertyStruct.const_156,true));
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_795,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_348,true));
         _loc1_.push(new PropertyStruct("antialias_type",_field.antiAliasType,PropertyStruct.const_156,true));
         ...
         _loc1_.push(new PropertyStruct("grid_fit_type",_field.gridFitType,PropertyStruct.const_156,true));
         ...
         _loc1_.push(new PropertyStruct("restrict",_field.restrict,PropertyStruct.const_156,false));
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_516,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.const_156,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_516,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_56,true));
         _loc1_.push(new PropertyStruct("margin_left",var_73.left,PropertyStruct.const_62,true));
         _loc1_.push(new PropertyStruct("margin_top",var_73.top,PropertyStruct.const_62,true));
         _loc1_.push(new PropertyStruct("margin_right",var_73.right,PropertyStruct.const_62,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_73.bottom,PropertyStruct.const_62,true));
         _loc1_.push(new PropertyStruct("auto_size",var_504,PropertyStruct.const_156,var_504 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_516,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_362 = var_362;
         _loc1_.var_73 = var_73.clone(_loc1_.setTextMargins);
         _loc1_.var_504 = var_504;
         _loc1_.var_709 = var_709;
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_504 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_504 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_504 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_504 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
