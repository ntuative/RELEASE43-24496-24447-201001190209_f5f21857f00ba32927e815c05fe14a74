package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected static const const_1012:String = "scale_to_fit_items";
      
      protected static const DEF_RESIZE_ON_ITEM_UPDATE:Boolean = false;
      
      protected static const const_1386:Boolean = true;
      
      protected static const const_1013:String = "auto_arrange_items";
      ...
      protected var var_708:Boolean = true;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_96 = 0;
         var_72 = 0;
         _horizontal = param2 == WindowType.const_295;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         _drawable = var_5 || !testParamFlag(WindowParam.const_31);
         _container = var_29.create("_CONTAINER","",WindowType.const_327,WindowStyle.const_267,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
      ...
      {
         return new Rectangle(var_501 * maxScrollH,var_503 * maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            var_501 = param1;
            _container.x = -var_501 * maxScrollH;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1014,_spacing,PropertyStruct.const_62,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1013,var_708,PropertyStruct.const_56,var_708 != const_1386));
         _loc1_.push(new PropertyStruct(const_1012,var_502,PropertyStruct.const_56,var_502 != const_1385));
         _loc1_.push(new PropertyStruct(const_1015,var_1055,PropertyStruct.const_56,var_1055 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            var_503 = param1;
            _container.y = -var_503 * maxScrollV;
            var_29.invalidate(_container,visibleRegion,WindowRedrawFlag.const_69);
         }
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_1015:
                  ...
                  break;
               case const_1013:
                  var_708 = _loc2_.value as Boolean;
                  break;
            }
         }
