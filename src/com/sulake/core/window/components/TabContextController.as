package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1025:String = "content";
      
      private static const const_1026:String = "selector";
       
      
      private var var_1076:Boolean = false;
      
      protected var var_872:ITabSelectorWindow;
      
      private var var_765:Boolean = false;
      
      protected var var_1530:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1530 == null)
         {
            var_1530 = findChildByTag(TabContextController.const_1025) as IWindowContainer;
         }
         return var_1530;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_872 == null)
         {
            var_872 = findChildByTag(TabContextController.const_1026) as ITabSelectorWindow;
            if(var_872 != null)
            {
               var_872.procedure = selectorEventProc;
            }
         }
         return var_872;
      }
      ...
      {
         return !!var_765 ? selector.iterator : null;
      }
