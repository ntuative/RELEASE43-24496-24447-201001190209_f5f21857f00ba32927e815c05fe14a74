package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_777:IItemListWindow;
      
      private var var_338:IScrollbarWindow;
      
      private var var_1401:Boolean = true;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_scrollBar.method_3(WindowState.const_64))
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_338)
         {
            ...
            if(var_338)
            {
               var_338.addEventListener(WindowEvent.const_230,scrollBarEventProc);
               var_338.addEventListener(WindowEvent.const_198,scrollBarEventProc);
            }
         }
         return var_338;
      }
      ...
      override public function dispose() : void
      {
         if(var_338)
         {
            var_338.removeEventListener(WindowEvent.const_230,scrollBarEventProc);
            var_338.removeEventListener(WindowEvent.const_198,scrollBarEventProc);
            var_338 = null;
         }
         if(var_777)
         {
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_198)
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_777)
         {
            var_777 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_777;
      }
