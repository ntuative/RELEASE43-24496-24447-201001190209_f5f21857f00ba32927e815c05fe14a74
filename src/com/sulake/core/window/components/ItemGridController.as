package com.sulake.core.window.components
{
   ...
   public class ItemGridController extends ItemListController implements IItemGridWindow
   {
      ...
      public function ItemGridController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         _horizontal = param2 != WindowType.const_386;
         var_502 = true;
         if(!_horizontal)
         {
      ...
      public function getGridItemIndex(param1:IWindow) : int
      {
         ...
         return _loc2_.getListItemIndex(param1) * method_2 + getColumnIndex(_loc2_);
      }
      
      protected function addColumnForItem(param1:IWindow) : IItemListWindow
      {
         var _loc2_:IItemListWindow = var_29.create(_name + "_COLUMN_" + numListItems,null,WindowType.const_282,WindowStyle.const_267,0 | 0,new Rectangle(0,0,Math.max(param1.width,0),Math.max(param1.height,0)),listEventProc,null,numListItems,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IItemListWindow;
      ...
      protected function offsetGridItemsForwards(param1:IWindow, param2:uint) : void
      {
         ...
         else
         {
            ...
            resolveColumnByIndex(param2).addListItemAt(param1,param2 / method_2);
         }
         var _loc10_:* = 0;
         _loc9_ = 0;
         while(_loc9_ < _loc6_)
      ...
      protected function resolveColumnForNextItem(param1:IWindow) : IItemListWindow
      {
         ...
         if(_loc2_ > 0)
         {
            ...
            _loc6_ = _loc5_ > -1 ? _loc5_ == method_2 - 1 : true;
            if(_loc6_)
            {
      ...
      {
         return getListItemAt(param1 % method_2) as IItemListWindow;
      }
