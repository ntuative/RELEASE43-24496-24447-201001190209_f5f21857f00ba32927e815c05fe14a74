package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_480:String = "slider_bar";
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.name)
            {
               case ScrollbarController.const_480:
      ...
      {
         return getChildByName(ScrollbarController.const_750) as WindowController;
      }
      ...
      {
         return track.getChildByName(ScrollbarController.const_480) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_774 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_774 != null)
         {
            _loc1_ = findParentByName(var_774) as IScrollableWindow;
            if(_loc1_ == null && var_23 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_23).findChildByName(var_774) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_51)
         {
            ...
            else if(param2.name == ScrollbarController.const_750)
            {
               ...
               _loc5_ = WindowController(param2).getChildByName(ScrollbarController.const_480).rectangle;
               if(_horizontal)
               {
         ...
         if(param1.type == WindowMouseEvent.const_1009)
         {
