package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_2149 = new Dictionary();
         TypeCodeTable.fillTables(var_1507,var_2149);
         var_1280 = new Dictionary();
         var_2148 = new Dictionary();
         StateCodeTable.fillTables(var_1280,var_2148);
         ...
         {
            var_364 = new Array();
            var_364.push(WindowState.const_58);
            var_364.push(WindowState.const_64);
            var_364.push(WindowState.const_88);
            var_364.push(WindowState.const_44);
            var_364.push(WindowState.const_73);
            var_364.push(WindowState.const_71);
            var_364.push(WindowState.const_89);
            var_364.push(WindowState.const_80);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1280)
         {
            _loc3_.push(var_1280[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc18_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1507[_loc9_],uint(_loc10_),_loc15_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer) : void
      {
         if(true)
         {
            var_573[param1] = new Array(SkinContainer.const_1119);
         }
