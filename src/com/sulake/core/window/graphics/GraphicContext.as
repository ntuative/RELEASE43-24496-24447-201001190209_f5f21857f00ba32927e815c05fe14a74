package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_897:uint = 256;
      ...
      public static const const_1562:uint = 128;
      
      public static const const_1460:uint = 64;
      
      public static const const_587:uint = 4;
      
      public static const const_1220:uint = 0;
      
      public static const const_1160:uint = 16;
      
      public static const const_728:uint = 1;
      
      public static const const_1246:uint = 8;
      ...
      protected var var_1532:Boolean;
         ...
         if(var_583)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1532,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1532,16777215);
                  }
                  var_363 += bitmap.width * bitmap.height * 4;
               }
