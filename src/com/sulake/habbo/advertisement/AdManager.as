package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1800:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_409,0,0,_loc4_,var_1394,var_1800,var_1801));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         ...
         var_1803 = int(_config.getKey("interstitial.show.time","5000"));
         var_1393 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1154 = _loc2_.imageUrl;
         var_1394 = _loc2_.clickUrl;
         if(var_1154 != "" && var_1394 != "")
         {
            _loc3_ = var_1154;
            ...
            _loc4_ = new URLRequest(var_1154);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1153 = _loc2_.imageUrl;
         var_1804 = _loc2_.clickUrl;
         var_626 = getTimer();
         if(var_1153 != "")
         {
            _loc3_ = var_1153;
            ...
            var_218.start();
            _loc4_ = new URLRequest(var_1153);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_452,0,0,param1.bitmapData,var_1804));
            var_626 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1801 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1393 > 0 && var_1395 >= var_1393)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_626;
         if(_loc1_ > var_1802)
         {
            ++var_1395;
      ...
      {
         var_665 = param2 as IHabboCommunicationManager;
         if(var_665 == null)
         {
            return;
         }
         _connection = var_665.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1800 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
