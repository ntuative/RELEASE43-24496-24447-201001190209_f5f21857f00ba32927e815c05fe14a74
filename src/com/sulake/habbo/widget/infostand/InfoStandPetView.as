package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1619:String = "level";
      
      private var var_110:IItemListWindow;
      
      private const const_1611:String = "energy";
      ...
      private const const_1614:uint = 3355443;
      
      private var var_216:IBorderWindow;
      
      private const const_1613:int = 158;
      
      private const const_1616:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_276:PetCommandTool;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_216 != null)
         {
            var_110 = var_216.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_110 == null || var_216 == null || var_66 == null)
         {
            return;
         }
         ...
         var_216.height = NaN;
         _window.width = Math.max(var_216.width,var_66.width);
      ...
      private function openTrainView() : void
      {
         if(var_276 == null)
         {
            var_276 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1094.getValue(var_601) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_276.showWindow(true);
            var_276.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1619,param1.level,param1.levelMax);
         updateStateElement(const_1612,param1.experience,param1.experienceMax);
         updateStateElement(const_1611,param1.energy,param1.energyMax);
         ...
         updateWindow();
         var_601 = param1.id;
         var_1094.remove(param1.id);
         var_1094.add(param1.id,param1);
         if(var_276 && var_276.isVisible() && param1.isOwnPet)
         {
            var_276.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_276.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1613,const_1616,false);
         ...
         _loc5_.fillRect(_loc6_,const_1614);
