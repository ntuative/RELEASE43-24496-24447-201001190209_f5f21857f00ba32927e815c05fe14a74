package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellView
   {
      ...
      public function createMainWindow() : void
      {
         ...
         var_59 = (var_321.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(var_59 == null)
         {
      ...
      public function update() : void
      {
         ...
         if(_list != null)
         {
            ...
            {
               _list.addListItem(createListItem(var_321.users[_loc1_] as String,_loc1_));
               _loc1_++;
            }
         }
      }
