package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_1396:Number = 10;
      
      private static const const_1395:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_898,var_899,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_898,var_899,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1090 = param1.chatType;
         var_898 = param1.userId;
         var_734 = param1.userName;
         var_899 = param1.userCategory;
         _message = param1.text;
         var_1091 = param1.userX;
      ...
      public function renderView() : void
      {
         ...
         if(var_191 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               ...
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_372 = Math.max(0,(0 - _loc5_.height) / 2);
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_900 != 0)
            {
               _loc30_ = uint(var_900 >> 16 & 255);
               _loc31_ = uint(var_900 >> 8 & 255);
               _loc32_ = uint(var_900 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1090 == RoomWidgetChatUpdateEvent.const_241)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_734);
            }
            else if(var_1090 == RoomWidgetChatUpdateEvent.const_266)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_734);
            }
            else
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_332 + _loc20_.textWidth + const_478;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_898,var_899,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_898,var_899,_roomId,_roomCategory,param1);
      }
