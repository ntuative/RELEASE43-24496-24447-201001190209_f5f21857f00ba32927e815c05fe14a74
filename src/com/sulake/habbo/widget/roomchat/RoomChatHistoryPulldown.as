package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_745:int = 150;
      
      private static const const_744:int = 250;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_43 = param3;
         var_1730 = (_assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         var_1371 = (_assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         var_1726 = (_assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         var_1372 = (_assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         var_1370 = (_assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         var_1729 = (_assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         ...
         _window = _windowManager.createWindow("chat_pulldown","",HabboWindowType.const_53,HabboWindowStyle.const_39,HabboWindowParam.const_38,new Rectangle(0,0 - const_70,param3.width,const_70),null,0) as IWindowContainer;
         var_43.addChild(_window);
         var_104 = _windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_354,HabboWindowStyle.const_40,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_70),null,0) as IRegionWindow;
         if(var_104 != null)
         {
            var_104.background = true;
            var_104.alphaTreshold = 0;
            var_104.addEventListener(WindowMouseEvent.const_51,onPulldownMouseDown);
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_371:
               var_77.blend += param1 / const_744;
               _window.blend += param1 / const_744;
               if(false)
               {
                  state = const_316;
               }
               break;
            case const_736:
               var_77.blend = 0 - param1 / const_745;
               _window.blend = 0 - param1 / const_745;
               if(true)
               {
                  state = const_185;
               }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(var_1727 == _window.width)
         {
            return;
         }
         var_1727 = _window.width;
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               tileBitmapHorz(var_1730.clone(),_loc7_);
               _loc1_.bitmap = _loc7_;
            }
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               _loc8_ = new BitmapData(_loc3_.width,_loc3_.height);
               tileBitmapHorz(var_1371.clone(),_loc8_);
               _loc3_.bitmap = _loc8_;
            }
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               _loc9_ = new BitmapData(_loc4_.width,_loc4_.height);
               tileBitmapHorz(var_1371.clone(),_loc9_);
