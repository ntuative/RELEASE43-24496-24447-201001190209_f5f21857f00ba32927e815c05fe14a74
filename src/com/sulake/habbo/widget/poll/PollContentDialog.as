package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
            ...
            if(_loc2_)
            {
               ...
               while(_loc3_ < _loc2_.numListItems)
               {
                  ...
                  if(_loc4_)
                  {
                     ...
                     if(_loc5_)
                     {
                        if(_loc5_.method_3(WindowState.const_44))
                        {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_699[var_1032] as Dictionary;
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_1032;
         if(var_1032 < var_699.length)
         {
            _loc1_ = var_699[var_1032] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_699.length);
                  _loc2_.text = _loc6_;
               }
