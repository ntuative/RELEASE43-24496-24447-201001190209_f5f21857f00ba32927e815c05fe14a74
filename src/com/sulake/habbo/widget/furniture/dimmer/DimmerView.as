package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_1165:XML;
      
      private var var_398:int;
      
      private var var_460:DimmerViewColorGrid;
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = var_242.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            var_242.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_53,HabboWindowStyle.const_39,0 | 0,new Rectangle(const_1039,const_1041,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               var_460 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,_widget.windowManager,_widget.assets);
            }
         }
         ...
         var_242 = ITabContextWindow(_window.findChildByName("tab_context"));
         selectTab(_widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < var_242.numTabItems)
         {
            _loc6_ = var_242.getTabItemAt(_loc2_);
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(var_460 != null)
         {
            var_460.setSelectedColorIndex(param1);
         }
         _widget.previewCurrentSetting();
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = var_242.selector.getSelected();
         return var_242.selector.getSelectableIndex(_loc1_);
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_962 = _loc2_.light;
         if(var_340 != null)
         {
            var_340.setValue(var_962);
         }
         var_398 = colors.indexOf(_loc2_.color);
         if(var_460 != null)
         {
            var_460.setSelectedColorIndex(var_398);
         }
