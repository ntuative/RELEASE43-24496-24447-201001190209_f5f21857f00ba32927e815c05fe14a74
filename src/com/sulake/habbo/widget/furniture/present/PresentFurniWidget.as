package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_382,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_458,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_355,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_352,onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_382,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_458,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_355,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_352,onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomWidgetPresentDataUpdateEvent.const_355:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_352:
               if(!var_227)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_382:
               if(!var_227)
               {
                  return;
               }
      ...
      {
         var _loc1_:* = null;
         if(var_227 || var_155 == -1 || !_controller)
         {
            return;
         }
         var_227 = true;
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_498,var_155);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_53,HabboWindowStyle.const_39,0 | 0,new Rectangle(const_1039,const_1041,2,2),null,0) as IWindowContainer;
