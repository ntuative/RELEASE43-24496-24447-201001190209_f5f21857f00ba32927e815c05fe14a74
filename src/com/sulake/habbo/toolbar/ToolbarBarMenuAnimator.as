package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1116:Number = 90;
      
      private static const const_766:int = 50;
      
      private static const const_1095:Number = 25;
      
      private static const const_1094:int = 50;
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var_484.push(param1.name);
         var_483.push(param2);
         param1.addEventListener(WindowEvent.const_427,windowEventListener);
         param1.addEventListener(WindowEvent.const_198,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_483[var_484.indexOf(param1)];
      }
      ...
      {
         return var_484[var_483.indexOf(param1)];
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_556[_loc3_] = new Array();
            }
            if(var_556[_loc3_].indexOf(param1) < 0)
            {
               var_556[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_766 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_766 || param1.desktop.height - param1.y < const_1094;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_484[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_556[_loc3_].length)
                  {
                     repositionWindow(var_556[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
