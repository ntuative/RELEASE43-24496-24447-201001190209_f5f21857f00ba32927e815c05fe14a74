   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               var_806.push(new XML());
               var_807.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            var_807[var_59] = param6.clone();
         }
      ...
      {
         if(var_1182 == true || var_647 == 0)
         {
            if(false)
            {
               ++var_59;
               if(var_59 >= var_806.length)
               {
                  var_59 = 0;
                  ++var_647;
               }
      ...
      {
         return var_806.length;
      }
      
      public function hasNextState() : Boolean
      {
         return var_1182 == false && var_647 == 1 && var_1241 != _state;
      }
      ...
      {
         var _loc2_:* = null;
         if(var_59 <= var_807.length)
         {
            _loc2_ = var_807[var_59];
