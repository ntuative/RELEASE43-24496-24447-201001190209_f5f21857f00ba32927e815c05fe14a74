package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_665.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_107,onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_948,onSetToolbarIconBitmapEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_341,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_507,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_839,onHideWindowEvent);
         _state = true;
