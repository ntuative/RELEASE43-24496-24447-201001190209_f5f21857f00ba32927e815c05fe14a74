package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_1945.clone());
      ...
      {
         var_1945 = IWindowContainer(var_56.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1150;
      }
   }
}
