package com.sulake.habbo.moderation
{
   ...
   public class ModerationMessageHandler
   {
      ...
      public function ModerationMessageHandler(param1:ModerationManager)
      {
         ...
         _connection.addMessageEvent(new RoomChatlogEvent(method_11));
      ...
      private function method_11(param1:RoomChatlogEvent) : void
      {
         var _loc2_:RoomChatlogMessageParser = param1.getParser();
         var _loc3_:Array = new Array();
         _loc3_.push(_loc2_.data);
         var _loc4_:Dictionary = new Dictionary();
         onChatlog("Room Chatlog: " + _loc2_.data.roomName,WindowTracker.const_684,_loc2_.data.roomId,_loc3_,_loc4_);
      }
