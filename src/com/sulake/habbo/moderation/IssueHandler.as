package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_411:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         var_411 = new UserInfoCtrl(_window,var_63,_loc3_.message);
         var_1009 = new UserInfoCtrl(_window,var_63,_loc3_.message);
         var_411.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_120.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_1009.load(_loc4_,var_120.reportedUserId);
         }
         else
         {
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_63.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_63,WindowTracker.const_819,_loc2_),_window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            var_411 = new UserInfoCtrl(_window,var_63,_loc3_.message);
            var_411.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
