package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1096:int = 8;
      
      public static const const_360:int = 10;
      ...
      private function refreshObj(param1:BitmapData, param2:RoomThumbnailObjectData) : void
      {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1098,_loc4_.y + const_1097 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_2044[param1]);
      }
      ...
      private function getLoc(param1:int, param2:int) : Point
      {
         ...
         return new Point(param1 * const_767 + _loc3_,param2 * const_1096);
      }
      ...
      private function refreshObjects(param1:BitmapData, param2:Array) : void
      {
         ...
         var _loc4_:* = null;
         _loc3_ = 0;
         while(_loc3_ <= const_360)
         {
            var_1008[_loc3_] = null;
            _loc3_++;
         }
         for each(_loc4_ in param2)
         {
            var_1008[_loc4_.pos] = _loc4_;
         }
         _loc3_ = 0;
         while(_loc3_ <= const_360)
         {
            if(false)
            {
               refreshObj(param1,var_1008[_loc3_]);
            }
            _loc3_++;
         }
      }
