package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      {
         setEnabled(_bgTabButton,this.var_88.mode != ThumbnailEditorModel.const_35);
         setEnabled(var_1391,this.var_88.mode != ThumbnailEditorModel.const_52);
         setEnabled(var_1392,this.var_88.mode != ThumbnailEditorModel.const_32);
      }
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_88.mode = ThumbnailEditorModel.const_35;
         this.reload();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1391 = IButtonWindow(find("top_tab"));
         var_1392 = IButtonWindow(find("obj_tab"));
         var_1798 = IWindowContainer(find("tile_grid"));
         var_1799 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1391,onTopTabButton);
         Util.setProcDirectly(var_1392,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_360)
            {
      ...
      private function onObjTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_88.mode = ThumbnailEditorModel.const_32;
         this.reload();
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = var_1799;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_53,HabboWindowStyle.const_39,HabboWindowParam.const_68,new Rectangle(0,0,param1.width,66)));
