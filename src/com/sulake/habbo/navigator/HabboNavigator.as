package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_1673:ISessionDataManager;
      
      private var var_1674:RoomCreateViewCtrl;
      
      private var var_1671:RoomThumbnailRenderer;
      ...
      private var var_440:MainViewCtrl;
      
      private var var_1672:Array;
      
      private var var_997:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_440 = new MainViewCtrl(this);
         var_1109 = new RoomInfoViewCtrl(this);
         var_1674 = new RoomCreateViewCtrl(this);
         var_1671 = new RoomThumbnailRenderer(this);
         var_997 = new GuestRoomPasswordInput(this);
         var_321 = new GuestRoomDoorbell(this);
         var_391 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_440.startSearch(Tabs.const_193,Tabs.const_324,param1);
         var_440.mainWindow.activate();
      }
      ...
      {
         if(param1 != null && var_202 != null)
         {
            var_202.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_202 != null)
         {
            var_202.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_107,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_202.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_107,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1673 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_440.startSearch(Tabs.const_260,Tabs.const_195);
         var_391.getTab(Tabs.const_260).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_440.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
