package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_724:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_1068 = new Timer(100);
         var_1068.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_67 = new Array();
      ...
      private function prepare() : void
      {
         ...
         var_893 = new TextFieldManager(_navigator,ITextFieldWindow(var_35.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_893.getText();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         var_1570 = _navigator.data.hcMember;
      }
      ...
      {
         var_893.goBackToInitialState();
         var_893.input.textBackgroundColor = 4294967295;
         var_724 = var_67[0];
         if(var_1570 != _navigator.data.hcMember)
         {
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_53,HabboWindowStyle.const_39,HabboWindowParam.const_68,new Rectangle(0,0,100,300)));
      }
      ...
      {
         var _loc1_:Boolean = var_893.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_724.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1067 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1067 = true;
            _loc3_.y = 1;
