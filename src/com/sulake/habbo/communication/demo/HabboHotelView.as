package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_727:uint = 0;
      
      private var var_600:IAssetLibrary;
      ...
      {
         var _loc3_:AssetLoaderStruct = var_600.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
      ...
      private function bannerLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = var_600.getAssetByName(_loc2_.assetName);
         ...
         else if(param1.type == AssetLoaderEvent.const_30)
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_389));
            }
      ...
      public function method_16(param1:String, param2:Function) : void
      {
         var _loc3_:AssetLoaderStruct = var_600.loadAssetFromFile("hotel_view_banner_" + var_727,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
