package com.sulake.habbo.communication.demo
{
   ...
   public class SSOTicket extends EventDispatcher
   {
      ...
      private var var_1290:IHabboWebLogin;
      ...
      public function SSOTicket(param1:IAssetLibrary, param2:IHabboWebLogin, param3:String)
      {
         ...
         _assets = param1;
         var_1290 = param2;
         var_1291 = "http://" + param3 + "/client";
         var_1290.init();
         var_1290.addEventListener(HabboWeb.const_201,requestClientURL);
      }
      ...
      {
         var _loc2_:String = var_1291;
         if(_assets.hasAsset(_loc2_))
         {
            Logger.log("[CoreLocalizationManager] reload localization for url: " + var_1291);
         }
         var _loc3_:URLRequest = new URLRequest(var_1291);
         if(_assets.hasAsset(_loc2_))
         {
      ...
      private function clientURLComplete(param1:Event = null) : void
      {
         ...
         {
            var_1290.requestReAuthenticate();
         }
         else
         {
            try
            {
               var_1520 = /\"sso.ticket\" : \"(.*?)\"/.exec(data)[1];
               var_2165 = /\"flash.client.url\" : \"(.*?)\"/.exec(data)[1];
               if(false)
               {
