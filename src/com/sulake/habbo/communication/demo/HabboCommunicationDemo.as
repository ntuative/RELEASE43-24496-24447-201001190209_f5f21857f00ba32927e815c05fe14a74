package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2084:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1475:ILogger;
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_2083)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_680 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_680);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1258,var_2082));
         var _loc2_:String = "";
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_487.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_487.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_2084);
      ...
      {
         var_680 = _habboConfiguration.getKey("sso.ticket",null);
         var_1258 = _habboConfiguration.getKey("flash.client.url","");
         ...
         if(var_680 != null)
         {
            var_79.mode = HabboConnectionType.const_475;
            var_79.initConnection(HabboConnectionType.const_253);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1475 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_572);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_2084 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_79.mode)
         {
            case HabboConnectionType.const_475:
               ...
               var_1020 = _loc4_;
               var_181.method_16(_loc7_ + "?token=" + var_1020,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1226:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1316:
               var_1021 = generateRandomHexString(30);
               var_487 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_487.init(var_1021);
               _loc8_ = var_487.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1020);
         ...
         var_487 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 100;
         while(_loc12_.length < 64)
         {
            var_1021 = generateRandomHexString(30);
            var_487.init(var_1021);
            _loc12_ = var_487.getPublicKey(10);
            _loc13_--;
            if(_loc13_ == 0)
            {
            }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_34.events.addEventListener(RoomSessionEvent.const_95,onRoomSessionEnded);
      }
