package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_604:FaqCategory;
      
      private var var_605:FaqCategory;
      ...
      {
         super();
         var_605 = new FaqCategory(-999,"${help.faq.title.urgent}");
         _frontPageNormal = new FaqCategory(-9999,"${help.faq.title.normal}");
         var_604 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
         var_128 = new Map();
      }
      ...
      {
         var _loc4_:* = null;
         if(var_605.hasItem(param1))
         {
            var_605.getItem(param1).answerText = param2;
         }
         if(_frontPageNormal.hasItem(param1))
         {
            _frontPageNormal.getItem(param1).answerText = param2;
         }
         if(var_604.hasItem(param1))
         {
            var_604.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
