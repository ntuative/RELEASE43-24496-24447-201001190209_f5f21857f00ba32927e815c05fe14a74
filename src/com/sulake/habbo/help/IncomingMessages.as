package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            var_44.tellUI(HabboHelpViewEnum.const_216,_loc4_);
         }
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_44.tellUI(HabboHelpViewEnum.const_254,_loc6_);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         var_44.tellUI(HabboHelpViewEnum.const_143);
      }
      ...
      {
         var_44.showUI(HabboHelpViewEnum.const_297);
      }
      ...
      private function onTutorialStatus(param1:IMessageEvent) : void
      {
         ...
         var_44.updateTutorial(_loc2_.hasChangedLooks,_loc2_.method_7,_loc2_.hasCalledGuideBot);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_44.showUI(HabboHelpViewEnum.const_467);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_44.showUI(HabboHelpViewEnum.const_710);
         var_44.tellUI(HabboHelpViewEnum.const_710,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         var_44.tellUI(HabboHelpViewEnum.const_568);
      }
