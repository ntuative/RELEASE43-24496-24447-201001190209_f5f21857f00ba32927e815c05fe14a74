package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_747:String = "selection_arrow";
      
      private static const const_746:String = "tile_cursor";
      ...
      private static const const_1061:String = const_335;
      ...
      public static const const_680:String = "RCL_LOADER_READY";
      ...
      public function RoomContentLoader()
      {
         var_618 = [];
         _wallItems = [];
         var_1761 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1763 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_386 = new Map();
         _events = new Map();
      ...
      {
         var _loc2_:String = var_532.getValue(param1) as String;
      ...
      {
         if(var_169 != null && var_169.hasWorldType(const_270 + param1))
         {
            return var_169.type;
         }
         return param1;
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           if(_loc9_[0] as String == "s")
                           {
                              ...
                              if(var_618.indexOf(_loc14_) < 0)
                              {
                                 var_618.push(_loc14_);
                              }
                           }
      ...
      {
         return [const_335,const_479,ROOM_CONTENT,const_746,const_747];
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = var_533.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1761.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_166 && _loc5_ != RoomObjectLogicEnum.const_120)
         {
            _loc6_ = "@shadow";
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,CoreComponent.const_1130);
               return;
            }
         }
      }
      ...
      {
         var _loc3_:String = var_532.getValue(param1) as String;
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_1763.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
            ...
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_462,_loc5_);
         }
         else
         {
      ...
      private function continueInitilization() : void
      {
         if(var_1764)
         {
            ...
            if(var_926 != null)
            {
               var_926.dispatchEvent(new Event(const_680));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_169 != null)
         {
            return var_169.getWorldHeightScale(const_270 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_926 = param1;
            var_1760 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_1759 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_1765 = param2.getKey("public.room.dynamic.download.url","");
            var_1762 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         _state = const_748;
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_166 && _loc5_ != RoomObjectVisualizationEnum.const_120)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      {
         if(getObjectCategory(const_270 + param1) == RoomObjectCategoryEnum.const_63)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_169 != null)
         {
            return var_169.getWorldScale(const_270 + param1);
         }
         return 32;
      }
