package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1328:int = 1500;
      
      private var var_1330:int = 255;
      
      private var var_1329:int = 255;
      
      private var var_1073:uint = 16777215;
      
      private var var_894:uint = 16777215;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_706:
                  ...
                  break;
               case RoomObjectRoomUpdateMessage.const_536:
                  _loc2_.setString(RoomObjectVariableEnum.const_699,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_561:
                  _loc2_.setString(RoomObjectVariableEnum.const_652,_loc3_.value);
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_441:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_187)
                  {
                     _loc8_ = "null";
                  }
                  ...
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_677:
            ...
            if(_loc7_)
            {
               ...
               _loc2_.setString(RoomObjectVariableEnum.const_1005,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_866,int(_loc5_.bgOnly));
            var_1073 = _color;
            var_1330 = var_1212;
            var_894 = _loc11_;
            var_1329 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_532,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc7_.x >= 0 && _loc7_.x < _loc14_ && _loc7_.y >= 0 && _loc7_.y < _loc15_)
         {
            ...
            _loc4_.setNumber(RoomObjectVariableEnum.const_1148,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1308,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_136 || _loc13_ == RoomPlaneData.const_257)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor() : void
      {
         ...
         if(var_726)
         {
            ...
            {
               _loc6_ = var_1073 >> 16 & 255;
               _loc7_ = var_1073 >> 8 & 255;
               _loc8_ = var_1073 & 255;
               _loc9_ = var_894 >> 16 & 255;
               _loc10_ = var_894 >> 8 & 255;
               _loc11_ = var_894 & 255;
               _loc12_ = (_loc1_ - var_726) / var_1328;
               _loc6_ += (_loc9_ - _loc6_) * _loc12_;
               _loc7_ += (_loc10_ - _loc7_) * _loc12_;
               _loc8_ += (_loc11_ - _loc8_) * _loc12_;
               _loc2_ = (_loc6_ << 16) + (_loc7_ << 8) + _loc8_;
               _loc3_ = var_1330 + (var_1329 - var_1330) * _loc12_;
               _color = _loc2_;
               var_1212 = _loc3_;
            }
            ...
            _loc5_.setNumber(RoomObjectVariableEnum.const_532,_loc2_);
         }
      }
   }
}
