package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      public function adDelayTimeout() : void
      {
         ...
         _loc1_.setNumber(RoomObjectVariableEnum.const_418,Number(false));
      }
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setNumber(RoomObjectVariableEnum.const_418,Number(false));
         var_765 = true;
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_971:
                  ...
                  _loc2_.setNumber(RoomObjectVariableEnum.const_418,Number(true));
                  var_1023 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_962);
            }
         }
      }
      ...
      {
         super.update();
         if(var_1023 > 0 && getTimer() > var_1023)
         {
            adDelayTimeout();
            var_1023 = 0;
         }
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_423)
               {
                  ...
                  {
                     eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_240,_loc5_,_loc6_,_loc7_));
