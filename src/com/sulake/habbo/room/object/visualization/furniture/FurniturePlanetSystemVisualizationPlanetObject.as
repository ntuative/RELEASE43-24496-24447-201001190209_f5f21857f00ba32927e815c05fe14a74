package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private var var_653:Vector3d;
      
      private var var_1164:Number;
      ...
      {
         var_653 = new Vector3d(0,0,0);
         _children = new Array();
         super();
         _name = param1;
         _index = param2;
         var_1164 = param3;
         var_1974 = param4 * 0 * 2 / 360;
         var_1435 = param5 * 0 * 2 / 360;
         _height = param6;
         var_817 = 0;
      }
      ...
      {
         var _loc3_:Number = var_1164 * Math.cos(var_817 + var_1435);
         var _loc4_:Number = var_1164 * Math.sin(var_817 + var_1435);
         var _loc5_:Number = _height;
         var_653.x = (_loc3_ - _loc4_) * (param2 / 2);
         var_653.y = (_loc4_ + _loc3_) * (param2 / 2) * 0.5 - _height * (param2 / 2);
         var_653.z = -int(4 * (_loc3_ + _loc4_) - 0.7);
         if(param1 != null)
         {
            var_653.add(param1);
         }
