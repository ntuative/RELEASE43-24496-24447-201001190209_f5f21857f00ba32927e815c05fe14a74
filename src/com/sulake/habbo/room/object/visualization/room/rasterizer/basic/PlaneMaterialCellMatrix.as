package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1376:int = const_302;
      ...
      public static const const_542:int = 6;
      
      public static const const_227:int = const_100;
      ...
      private var var_752:Vector3d = null;
      ...
      public function PlaneMaterialCellMatrix(param1:int, param2:int = 1, param3:int = 1, param4:Number = -1, param5:Number = 1, param6:Number = -1, param7:Number = 1)
      {
         ...
         var_1645 = param6;
         var_1643 = param7;
         var_752 = new Vector3d();
         if(var_1363 == const_542)
         {
            var_1119 = false;
         }
      }
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1362 == const_100)
         {
            _loc5_ = new Rectangle(0,0,var_40.width,var_442);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_442,var_40.width,var_442);
         }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(isStatic)
         {
            if(var_40 != null)
            {
               if(var_40.width == param2 && var_40.height == param3 && Vector3d.isEqual(var_752,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_442,param6,param7);
                     return param1;
                  }
                  return var_40;
               }
         ...
         switch(var_1363)
         {
            ...
            case const_542:
               ...
               break;
            default:
               _loc10_ = method_9(var_40,_loc8_);
         }
         var_442 = _loc10_;
         if(param1 != null)
         {
