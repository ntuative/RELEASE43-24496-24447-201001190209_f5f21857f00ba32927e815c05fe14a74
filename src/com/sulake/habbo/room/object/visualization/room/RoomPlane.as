package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(_bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (_type == const_262 || _type == const_183))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!var_837 || false && false && !var_159 || var_576 == null)
         {
            return;
         }
         ...
         if(var_159)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(var_412);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < var_203.length)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  _loc12_ = _loc3_.type;
                  var_576.updateMask(var_64,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  var_671.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < var_271.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  var_1010.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            var_159 = false;
      ...
      private function getTextureIdentifier(param1:IRoomGeometry) : String
      {
         ...
         if(var_670 != null)
         {
            _loc2_ = var_670.getTextureIdentifier(param1.scale,normal);
         }
         return _loc2_;
      }
      ...
      private function renderTexture(param1:IRoomGeometry, param2:BitmapData) : void
      {
         ...
         if(_type == const_262 || _type == const_183)
         {
         ...
         if(true)
         {
            while(_loc1_ < var_203.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     _loc7_ = var_671[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc10_:* = null;
         if(param1 == null || var_672 == null || var_75 == null || var_272 == null || var_270 == null || var_412 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != var_1272)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != var_1027 || _loc4_.y != var_2047 || _loc4_.z != var_2049 || param1.scale != var_2053))
            {
               ...
               _loc6_ = 0;
               while(_loc6_ < var_1128.length)
               {
                  _loc5_ = Number(Vector3d.cosAngle(param1.directionAxis,var_1128[_loc6_]));
                  if(_loc5_ > -0.001)
                  {
                     if(_isVisible)
                     {
               ...
               _loc7_ = param1.getScreenPosition(var_672);
               _loc8_ = _loc7_.z;
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc4_:PlaneBitmapData = var_178.getValue(_loc3_) as PlaneBitmapData;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(needsNewTexture(param1,param2))
         {
            ...
            _loc4_ = var_178.getValue(_loc3_) as PlaneBitmapData;
            _loc8_ = null;
            if(_loc4_ != null)
            {
            ...
            if(var_670 != null)
            {
               _loc4_ = var_670.render(_loc8_,_id,_loc5_,_loc6_,param1.scale,_loc7_,var_1461,var_2054,var_2051,var_2048,var_2052,param2);
               if(_loc4_ != null)
               {
