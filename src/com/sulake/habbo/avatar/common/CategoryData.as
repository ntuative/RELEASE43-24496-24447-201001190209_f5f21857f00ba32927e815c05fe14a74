package com.sulake.habbo.avatar.common
{
   public class CategoryData
   {
      ...
      public function get currentColour() : AvatarEditorColorItem
      {
         if(var_629 > -1)
         {
            return var_339[var_629] as AvatarEditorColorItem;
         }
         return null;
      }
      ...
      public function selectColour(param1:int) : AvatarEditorColorItem
      {
         ...
         if(var_629 >= 0)
         {
            _loc3_ = var_339[var_629];
            _loc3_.isSelected = false;
         }
         if(var_339.length > param1)
         {
            _loc2_ = var_339[param1] as AvatarEditorColorItem;
            _loc2_.isSelected = true;
         }
         var_629 = param1;
      ...
      public function selectColourWithId(param1:int) : void
      {
         var _loc3_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < var_339.length)
         {
            _loc3_ = var_339[_loc2_];
