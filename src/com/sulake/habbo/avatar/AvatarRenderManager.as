package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_885:CoreComponent;
      
      private var var_32:AssetAliasCollection;
      
      private var var_905:PaletteManager;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_602 = RenderMode.const_1280;
         if(param1 is CoreComponent)
         {
            var_885 = CoreComponent(param1);
            var_885.events.addEventListener(Component.COMPONENT_EVENT_RUNNING,onComponentsRunning);
         }
      ...
      {
         var _loc2_:* = null;
         _loc2_ = var_287.getValue(AvatarType.const_92) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.initConfiguration(_habboConfiguration);
         }
         _loc2_ = var_287.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.initConfiguration(_habboConfiguration);
         }
      ...
      {
         var _loc5_:* = null;
         var _loc1_:AssetLibraryCollection = var_885.assets as AssetLibraryCollection;
         var _loc2_:int = 0;
         ...
         var_905 = new PaletteManager(_loc1_,_loc3_);
         ...
         var_287.add(AvatarType.const_92,_loc5_);
         _loc5_ = new AvatarStructure(this,assets,_loc1_,AvatarType.PET);
         _loc5_.addEventListener(AvatarStructure.AVATAR_STRUCTURE_INIT,onStructureInit);
         var_287.add(AvatarType.PET,_loc5_);
      ...
      {
         var_602 = param1;
         if(var_602 == RenderMode.const_1186)
         {
            init();
         }
      }
      ...
      public function createPetImageNew(param1:int, param2:int, param3:uint, param4:String) : IAvatarImage
      {
         ...
         var _loc6_:AvatarStructure = var_287.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc6_ == null)
         {
            return null;
         }
      ...
      {
         var _loc2_:AvatarStructure = var_287.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc3_:AvatarStructure = var_287.getValue(AvatarType.const_92) as AvatarStructure;
         if(_loc3_ == null)
         {
            return null;
         }
