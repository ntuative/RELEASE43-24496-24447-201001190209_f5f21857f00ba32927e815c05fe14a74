package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_1634:PartOffsetData;
      
      private var var_737:AvatarActionManager;
      
      private var var_152:IAssetLibrary;
      
      private var var_2207:IAssetLibrary;
      
      private var var_1300:Boolean = false;
      
      private var var_1635:AvatarRenderManager;
      
      private var var_437:FigureData;
      ...
      private var var_606:AnimationManager;
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_606.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1373[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         if(param3.definition.isAnimation)
         {
            ...
            _loc8_ = var_606.getAnimation(_loc17_);
            if(_loc8_ != null)
            {
         ...
         for each(_loc14_ in param2.getPartTypeIds())
         {
            ...
            _loc23_ = var_437.getSetType(_loc14_);
            if(_loc23_ != null)
            {
               _loc24_ = var_437.getPalette(_loc23_.paletteID).getColor(_loc22_);
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_607 + " ready to go!");
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_92:
               var_1342.add(new AvatarStructureDownload(var_152,_loc5_,var_437));
               break;
            case AvatarType.PET:
         }
      ...
      {
         return var_606.getAnimation(param1);
      }
      ...
      {
         var_737 = new AvatarActionManager(var_152,var_607);
      }
      ...
      private function registerAnimations() : void
      {
         ...
         while(var_152.hasAsset("dance" + _loc1_))
         {
            ...
            var_606.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String) : IPartColor
      {
         ...
         var _loc4_:ISetType = var_437.getSetType(param2);
         if(_loc4_ == null)
         {
            return null;
         }
         return var_437.getPalette(_loc4_.paletteID).getColor(_loc3_);
      }
