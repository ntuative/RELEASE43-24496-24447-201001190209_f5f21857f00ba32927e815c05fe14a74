package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_1595 = parseInt(param1.@precedence);
         var_1594 = String(param1.@activepartset);
         var_1592 = String(param1.@assetpartdefinition);
         var_1598 = String(param1.@lay);
         var_1113 = String(param1.@geometrytype);
         var_1596 = Boolean(parseInt(param1.@main));
         var_1597 = Boolean(parseInt(param1.@method_5));
         var_1593 = Boolean(parseInt(param1.@animation));
         var _loc2_:String = String(param1.@prevents);
         if(_loc2_ != "")
         {
            var_1079 = _loc2_.split(",");
         }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         if(var_507.getValue(param1) == null)
         {
            var_507.add(param1,new Map());
         }
         var _loc4_:Map = var_507.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = var_507.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      {
         return var_1079.concat(getTypePrevents(param1));
      }
