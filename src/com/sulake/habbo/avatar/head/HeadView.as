package com.sulake.habbo.avatar.head
{
   ...
   public class HeadView implements IAvatarEditorCategoryView
   {
      ...
      public function HeadView(param1:HeadModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_652["null"] = new AvatarEditorGridView(param1,FigureData.const_125,param2,param3);
         var_652["null"] = new AvatarEditorGridView(param1,FigureData.const_142,param2,param3);
         var_652["null"] = new AvatarEditorGridView(param1,FigureData.const_134,param2,param3);
         var_652["null"] = new AvatarEditorGridView(param1,FigureData.const_144,param2,param3);
         var_652["null"] = new AvatarEditorGridView(param1,FigureData.const_145,param2,param3);
         attachImages();
