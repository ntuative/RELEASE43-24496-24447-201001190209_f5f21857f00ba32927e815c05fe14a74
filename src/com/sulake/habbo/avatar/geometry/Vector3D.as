package com.sulake.habbo.avatar.geometry
{
   public class Vector3D
   {
      ...
      public function cross(param1:Vector3D) : Vector3D
      {
         ...
         _loc2_.x = _y * param1.z - var_94 * param1.y;
         _loc2_.y = var_94 * param1.x - var_93 * param1.z;
      ...
      {
         return Math.sqrt(var_93 * var_93 + _y * _y + var_94 * var_94);
      }
      ...
      {
         return var_93 * param1.x + _y * param1.y + var_94 * param1.z;
      }
      ...
      {
         return "Vector3D: (" + var_93 + "," + _y + "," + var_94 + "," + var_912 + ")";
      }
