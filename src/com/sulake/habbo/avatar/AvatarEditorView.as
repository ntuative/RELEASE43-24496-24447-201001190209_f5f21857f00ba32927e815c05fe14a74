package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1528:IWindowContainer;
      ...
      private var var_1345:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager)
      {
         ...
         if(var_1528 == null)
         {
            ...
            var_1528 = _controller.windowManager.buildFromXML(_loc4_.content as XML) as IWindowContainer;
         }
      ...
      public function updateAvatar() : void
      {
         ...
         if(var_654 != null)
         {
            toggleCategoryView(var_654,true);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1345 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         updateAvatar();
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_654 = param1;
         var_1345.setSelected(var_1345.getSelectableByName(param1));
         _window.invalidate();
      }
