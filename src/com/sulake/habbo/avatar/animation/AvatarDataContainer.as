package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      {
         super();
         var_1398 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         var_1815 = parseInt(_loc2_,16);
         var_1817 = parseInt(_loc3_,16);
         _rgb = parseInt(_loc2_,16);
         var_1449 = _rgb >> 16 & 255;
         var_1450 = _rgb >> 8 & 255;
         _b = _rgb >> 0 & 255;
         var_1492 = var_1449 / 255 * 1;
         var_1493 = var_1450 / 255 * 1;
         var_1491 = _b / 255 * 1;
         if(var_1398 == 37)
         {
         ...
         _colorTransform = new ColorTransform(var_1492,var_1493,var_1491,_alphaMultiplier);
         var_944 = generatePaletteMapForGrayscale(var_1817,var_1815);
      }
      
      public function get reds() : Array
      {
         return var_944.getValue("reds") as Array;
      }
      ...
      {
         return var_944.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_944.getValue("greens") as Array;
      }
      ...
      {
         return var_944.getValue("alphas") as Array;
      }
