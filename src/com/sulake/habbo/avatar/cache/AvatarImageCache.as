package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1397:int = 60000;
      ...
      private var var_802:IAvatarImage;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc15_ != null)
            {
               ...
               if(_loc15_.type == AnimationLayerData.const_530)
               {
         ...
         if(_loc14_ == null)
         {
            ...
            _loc10_ = var_74.getParts(param1,(var_802 as AvatarImage).getFigure(),_loc6_,var_1113,_loc4_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_74.getCanvas(var_188,var_1113);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc28_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1218[param1])
            {
            ...
            else
            {
               ...
               if((_loc32_ == AvatarAction.const_982 || _loc32_ == AvatarAction.const_708) && (_loc6_ == AvatarBodyPartType.const_299 || _loc6_ == AvatarBodyPartType.const_1304 || _loc6_ == AvatarBodyPartType.const_1297) && _loc7_.color != null)
               {
