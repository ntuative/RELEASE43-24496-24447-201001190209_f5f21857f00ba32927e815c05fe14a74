package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      {
         return Math.ceil(this.var_212.length / const_322);
      }
      ...
      {
         if(this.var_722 >= this.getPageCount())
         {
            this.var_722 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_722 + 1) * const_322,this.var_212.length);
      }
