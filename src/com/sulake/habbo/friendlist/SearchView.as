package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      private var var_673:ITextFieldWindow;
      ...
      {
         var_673 = ITextFieldWindow(param1.findChildByName("search_str"));
         var_673.procedure = onSearchInput;
         var_673.addEventListener(WindowKeyboardEvent.const_111,onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            _list.getListItemAt(_loc1_).color = _friendList.laf.getRowShadingColor(FriendListTab.const_304,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_673.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
