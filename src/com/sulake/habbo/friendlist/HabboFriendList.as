package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1735:IAvatarRenderManager;
      
      private var var_1375:AvatarSearchResults;
      
      private var var_131:IHabboMessenger;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_759:FriendRequests;
      ...
      private var var_1736:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_391:FriendListTabs;
      
      private var var_1734:IHabboNotifications;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1374:OpenedToWebPopup;
      ...
      {
         var_1736 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_326 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1375 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1374 == null)
         {
            var_1374 = new OpenedToWebPopup(this);
         }
         var_1374.show(x,y);
      }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_759.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_759.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_391.findTab(FriendListTab.const_98).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_759.getCountOfOpenRequests() > 0 ? "2" : "0");
         var_202.events.dispatchEvent(_loc1_);
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_759 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_326.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_326.addCategory(new FriendCategory(FriendCategory.const_823,getText("friendlist.friends")));
         var_326.addCategory(new FriendCategory(FriendCategory.const_404,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_326.addFriend(new Friend(_loc4_));
         }
         var_391 = new FriendListTabs(new FriendListTabsDeps(this));
         _loc5_ = new Timer(120000);
         _loc5_.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
         _loc5_.start();
         getBuddyRequests();
         registerListeners();
         var_202.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_107,HabboToolbarIconEnum.FRIENDLIST));
      ...
      {
         var _loc2_:IAvatarImage = var_1735.createAvatarImage(param1,AvatarScaleType.const_101);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1735 = param2 as IAvatarRenderManager;
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_759.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_391.findTab(FriendListTab.const_98);
      ...
      {
         var_1734 = param2 as IHabboNotifications;
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_391.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      {
         var_202 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1375.searchReceived(_loc2_.friends,_loc2_.others);
