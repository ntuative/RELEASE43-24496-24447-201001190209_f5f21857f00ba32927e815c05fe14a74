package com.sulake.habbo.friendlist
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(_friendList.getXmlWindow(this.var_1163));
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(var_1405[var_1163]);
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
