package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_671);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_318);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_856);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_909);
            ...
            case RoomObjectCategoryEnum.const_36:
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_836)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_217)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_642);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1365;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_791;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_985;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1327);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_549.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImage(_loc4_,AvatarScaleType.const_50);
            var_549.add(_loc2_.petId,_loc5_);
         }
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_642);
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_594);
         _loc1_.push(RoomWidgetFurniActionMessage.const_563);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_551);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_690);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1183);
         _loc1_.push(RoomWidgetPetCommandMessage.const_540);
         _loc1_.push(RoomWidgetPetCommandMessage.const_569);
      ...
      public function dispose() : void
      {
         ...
         if(var_549 != null)
         {
            _loc1_ = var_549.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_549.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_432)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_517:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_594:
            ...
            case RoomWidgetUserActionMessage.const_403:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_551:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_690:
            ...
            case RoomWidgetUserActionMessage.const_524:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_569:
