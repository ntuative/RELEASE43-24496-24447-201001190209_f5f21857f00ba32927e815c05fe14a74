package com.sulake.habbo.ui
{
   ...
   public class FurnitureStickieWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_621,RoomWidgetStickieSendUpdateMessage.const_711,RoomWidgetStickieSendUpdateMessage.const_428];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetStickieSendUpdateMessage.const_428:
               ...
               {
                  _container.roomEngine.modifyRoomObjectData(_loc4_.method_1,RoomObjectCategoryEnum.const_29,_loc4_.colorHex + " " + _loc4_.text);
               }
               break;
            case RoomWidgetStickieSendUpdateMessage.const_711:
               ...
               if(_container != null && false)
               {
                  _container.roomEngine.deleteRoomObject(_loc5_.method_1,RoomObjectCategoryEnum.const_29);
               }
               break;
         }
         return null;
