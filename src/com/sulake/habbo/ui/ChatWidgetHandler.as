package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_433:Point = null;
      ...
      {
         return [RoomSessionChatEvent.const_132];
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_432.length)
            {
               _loc2_ = var_432.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_132:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_432.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_603.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_432.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_603.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_548,RoomWidgetChatSelectAvatarMessage.const_691];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_548:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_132,_container.roomSession,0,"Version 24496-24447-201001190140");
                           ...
                           case ":chooser":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_314);
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_691:
               _loc2_ = param1 as RoomWidgetChatSelectAvatarMessage;
               if(_loc2_ != null)
               {
                  _container.roomEngine.selectAvatar(_loc2_.roomId,_loc2_.roomCategory,_loc2_.method_1,true);
               }
         }
         return null;
      }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_731 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_731);
            }
            if(var_433 == null)
            {
               var_434.x = 0;
               var_434.y = 0;
               var_434.z = 0;
               var_433 = _loc4_.getScreenPoint(var_434);
               var_731 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_434.x = 0;
            var_434.y = 0;
            var_434.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_434);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_433.x || _loc8_.y != var_433.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_433,_loc5_));
