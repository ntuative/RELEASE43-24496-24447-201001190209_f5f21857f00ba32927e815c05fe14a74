   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            Logger.log("MeMenuWidgetHandler: set toolbar icon: " + var_202 + " " + _loc6_);
            if(var_202 != null && _loc6_ != null)
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_948,HabboToolbarIconEnum.MEMENU);
               _loc8_.bitmapData = _loc6_;
               var_202.events.dispatchEvent(_loc8_);
            }
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_534,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_346,onHelpTutorialEvent);
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_534,onFigureUpdate);
            _container.sessionDataManager.events.addEventListener(SessionCreditBalanceEvent.const_157,onCreditBalance);
         }
         var_25 = _container.inventory;
         if(var_25 != null)
         {
            (var_25 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_942,onAvatarEffectsChanged);
            (var_25 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_589,onHabboClubSubscriptionChanged);
         }
         var_202 = _container.toolbar;
         if(var_202)
         {
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_346,onHelpTutorialEvent);
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_96:
               ...
               break;
            case HabboHelpTutorialEvent.const_346:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_439));
         }
      }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetDanceMessage.const_578);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_620);
         ...
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_714);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_611);
         _loc1_.push(RoomWidgetStopEffectMessage.const_694);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1213);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_821);
         _loc1_.push(RoomWidgetToolbarMessage.const_574);
         _loc1_.push(RoomWidgetToolbarMessage.const_623);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_662);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1181);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_850);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_670);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_592);
         _loc1_.push(RoomWidgetRedeemClubPromoMessage.const_545);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_504);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1187);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_607);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_720);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_586);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetWaveMessage.const_539:
               ...
               break;
            case RoomWidgetDanceMessage.const_578:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_620:
               if(var_25 != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_611:
               ...
               if(var_90 != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_533)
               {
                  var_90.openCatalogPage(CatalogPageName.const_313,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_714:
               ...
               if(var_25 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_991:
                        var_90.openCatalogPage(CatalogPageName.const_1356,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_931:
                     ...
                     case RoomWidgetOpenInventoryMessage.const_1188:
                        ...
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1351:
                        break;
                     default:
            ...
            case RoomWidgetSetToolbarIconMessage.const_859:
               ...
               {
                  case RoomWidgetSetToolbarIconMessage.const_1368:
                     break;
                  default:
                     Logger.log("MeMenuWidgetHandler: unknown icon widget type: " + _loc4_.widgetType);
               }
               break;
            case RoomWidgetNavigateToRoomMessage.const_821:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_670:
               if(_container != null)
               {
                  _container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_574:
               _loc5_ = param1 as RoomWidgetToolbarMessage;
               if(var_202)
               {
                  var_202.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_25 != null)
                  {
                     _loc14_ = false;
                     if(_container != null && false)
            ...
            case RoomWidgetToolbarMessage.const_623:
               ...
               if(var_202)
               {
                  var_202.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_341,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_662:
               ...
               if(_container)
               {
                  ...
                  if(false && !_loc23_)
                  {
                     ...
                     if(_loc25_ && false)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_384,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_980));
                     }
                     _loc26_ = int(_container.config.getKey("avatar.editor.trial.promo")) > 0;
                     if(_loc26_ && true)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_384,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_1292));
                     }
                  }
                  if(false && _container.habboHelp.events)
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_702));
                  }
               }
               break;
            case RoomWidgetRedeemClubPromoMessage.const_545:
               _loc7_ = param1 as RoomWidgetRedeemClubPromoMessage;
               if(_loc7_ != null)
               {
                  _container.catalog.redeemClubPromo(_loc7_.code,_loc7_.method_17);
               }
               break;
            case RoomWidgetGetSettingsMessage.const_504:
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_312,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_607:
            ...
            case RoomWidgetStoreSettingsMessage.const_720:
               ...
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_312,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_586:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_700));
               }
               break;
            default:
