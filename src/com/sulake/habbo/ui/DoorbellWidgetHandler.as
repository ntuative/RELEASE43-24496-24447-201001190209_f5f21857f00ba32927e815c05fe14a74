package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_102:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_541,_loc2_.userName));
               break;
      ...
      {
         return [RoomWidgetLetUserInMessage.const_596];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_596:
      ...
      {
         return [RoomSessionDoorbellEvent.const_102,RoomSessionDoorbellEvent.const_118,RoomSessionDoorbellEvent.const_128];
      }
