      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDimmerPresetsEvent.const_416:
               ...
               _loc3_ = new RoomWidgetDimmerUpdateEvent(RoomWidgetDimmerUpdateEvent.const_636);
            ...
            case RoomEngineObjectEvent.const_91:
               _container.events.dispatchEvent(new RoomWidgetDimmerUpdateEvent(RoomWidgetDimmerUpdateEvent.const_933));
         }
      }
      
      public function getWidgetMessages() : Array
      {
         return [RoomWidgetFurniToWidgetMessage.const_658,RoomWidgetDimmerSavePresetMessage.const_675,RoomWidgetDimmerChangeStateMessage.const_553,RoomWidgetDimmerPreviewMessage.const_579];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_658:
               ...
               break;
            case RoomWidgetDimmerSavePresetMessage.const_675:
               if(validateRights())
               {
               ...
               break;
            case RoomWidgetDimmerChangeStateMessage.const_553:
               if(validateRights())
               {
