package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_223:DesktopLayoutManager;
      
      private var _events:EventDispatcher;
      
      private var var_202:IHabboToolbar = null;
      ...
      private var var_735:IRoomWidgetFactory = null;
      ...
      private var var_1861:uint = 16777215;
      ...
      public function RoomDesktop(param1:IRoomSession, param2:IAssetLibrary, param3:IConnection)
      {
         ...
         _widgets = new Map();
         var_222 = new Map();
         var_223 = new DesktopLayoutManager();
      }
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_462,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_417,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_633,onRoomContentLoaded);
         }
      }
      ...
      {
         var_202 = param1;
         var_202.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
      ...
      public function init() : void
      {
         ...
         {
            var_634 = _roomEngine.loadRoomResources(var_48.roomResources);
            if(false)
            {
               var_9 = false;
         ...
         {
            var_1162 = !var_435.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_48.roomId,var_48.roomCategory,var_258[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(_roomEngine != null && false)
         {
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_462,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_417,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_633,onRoomContentLoaded);
         }
         _roomEngine = null;
         var_34 = null;
         var_735 = null;
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_1861);
      ...
      {
         var_223.setLayout(param1,_windowManager);
         if(var_202 != null)
         {
            var_223.toolbarSize = var_202.size;
            var_223.toolbarOrientation = var_202.orientation;
         }
      }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = var_735.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         var_223.addWidgetWindow(_loc2_.mainWindow);
         ...
         param1 = "null";
         var _loc4_:RoomWidgetRoomViewUpdateEvent = new RoomWidgetRoomViewUpdateEvent(param1,var_223.roomViewRect);
      ...
      private function onToolbarRepositionEvent(param1:HabboToolbarEvent) : void
      {
         if(var_223 != null)
         {
            var_223.toolbarOrientation = param1.orientation;
         }
      }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc2_:int = int(param1.method_1);
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_665:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_293,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               if(var_1341 != null && _loc3_ == RoomObjectCategoryEnum.const_36)
               {
            ...
            case RoomEngineObjectEvent.const_583:
               ...
               _roomEngine.modifyRoomObject(param1.method_1,param1.category,RoomObjectOperationEnum.OBJECT_MOVE);
               break;
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc20_:* = null;
         var _loc2_:Rectangle = var_223.roomViewRect;
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_48.roomId,var_48.roomCategory,RoomVariableEnum.const_509);
            _loc13_ = _roomEngine.getRoomNumberValue(var_48.roomId,var_48.roomCategory,RoomVariableEnum.const_676);
            _loc14_ = _roomEngine.getRoomNumberValue(var_48.roomId,var_48.roomCategory,RoomVariableEnum.const_522);
            _loc15_ = _roomEngine.getRoomNumberValue(var_48.roomId,var_48.roomCategory,RoomVariableEnum.const_500);
         ...
         if(param1.iconId == HabboToolbarIconEnum.ZOOM)
         {
            if(var_48 != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  {
                     _loc3_.iconState = "2";
                     var_202.events.dispatchEvent(_loc3_);
                  }
                  else
                  {
                     _loc3_.iconState = "0";
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc2_:IRoomObject = _roomEngine.getRoomObject(param1.roomId,param1.roomCategory,param1.method_1,param1.category);
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_395:
               ...
               _loc2_ = _roomEngine.getRoomObject(param1.roomId,param1.roomCategory,param1.method_1,param1.category);
               if(_loc2_ == null)
               {
                  return;
               }
               _loc3_ = _localization.getKey(_loc2_.getType() + ".tooltip","${ads.roomad.tooltip}");
               var_172 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.WINDOW_TYPE_TOOLTIP,WindowStyle.const_267,WindowParam.const_83) as IToolTipWindow;
      ...
      {
         if(var_34 != null && var_48 != null && var_1162 && var_9)
         {
      ...
      {
         var _loc3_:IWindowContainer = var_223.getRoomView() as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
