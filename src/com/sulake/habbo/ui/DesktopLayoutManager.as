package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1598:String = "room_widget";
      
      private const const_1627:String = "room_desktop_layout_container";
      
      private const const_1030:String = "room_view";
      
      private var var_599:int = 50;
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = var_68.getChildByTag(const_1030) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = var_68.findChildByTag(const_1030) as IWindowContainer;
         if(_loc1_ != null)
         {
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         switch(param1)
         {
            case "LEFT":
               _loc2_.x = var_599;
               _loc2_.width = var_68.desktop.width - var_599;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = var_599;
               _loc2_.height = var_68.desktop.height - var_599;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = var_68.desktop.width;
      ...
      public function addWidgetWindow(param1:IWindow) : Boolean
      {
         ...
         {
            if(String(_loc2_[_loc4_]).indexOf(const_1598) == 0)
            {
