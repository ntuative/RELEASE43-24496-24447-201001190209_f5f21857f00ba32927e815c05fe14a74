package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1113:Number = 4285716709;
      ...
      private var var_1470:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1470 == 4294967295)
            {
               var_1470 = _loc1_.color;
            }
            _loc1_.color = const_1113;
         }
      }
      ...
      {
         _list = navigator.catalog.windowManager.buildFromXML(var_1468) as IItemListWindow;
         if(_list == null)
         {
