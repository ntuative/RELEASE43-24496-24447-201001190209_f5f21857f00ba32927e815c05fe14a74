package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2262:String = "magic.pixels";
      
      private var var_2261:String = "catalog.page.club";
      
      private var var_2272:String = "magic.credits";
      ...
      private function openCreditsPage() : void
      {
         ...
         var _loc1_:* = var_90.configuration.getKey("client.credits.embed.enabled","UserChatlogEvent") == "true";
         if(false && _loc1_)
         {
      ...
      {
         var_90.openCatalogPage(var_2261,true);
      }
