package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1172:IProductData;
      ...
      {
         super();
         var_1170 = param1.productType;
         var_1173 = param1.furniClassId;
         var_967 = param1.extraParam;
         var_968 = param1.productCount;
         var_1171 = param1.expiration;
         var_1172 = param2;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(productType)
         {
            ...
            case ProductTypeEnum.const_77:
               _loc6_ = _loc4_.getWallItemIcon(productClassId,param2,var_967);
               break;
