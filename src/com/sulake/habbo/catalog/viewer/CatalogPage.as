package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected var var_1313:XML;
      
      protected var _window:IWindowContainer;
      
      private var var_812:String;
      
      private var var_1185:EventDispatcher;
      
      private var _widgets:Array;
      
      private var _pageId:int;
      
      private var var_855:ICatalogViewer;
      ...
      {
         return _localization.hasLinks(var_812);
      }
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         var_1313 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1313) as IWindowContainer;
         if(_window == null)
         {
      ...
      private function createWidgets() : void
      {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1185;
            _loc2_.init();
         }
         var_1185.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1185.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_812);
      }
