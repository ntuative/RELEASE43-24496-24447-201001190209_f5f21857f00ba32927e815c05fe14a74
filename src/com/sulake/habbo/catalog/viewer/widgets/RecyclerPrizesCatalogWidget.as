package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1311:XML;
      
      private var _itemList:IItemListWindow;
      
      private var var_855:PrizeViewer;
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         {
            createLevelItem(var_686[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         var_855 = new PrizeViewer();
         var_903 = new Map();
         var_686 = recycler.getPrizeTable();
         if(var_686 == null)
         {
            return;
         }
         ...
         var_2099 = _loc1_.content as XML;
         populateItemGrid();
         if(false && var_686[0].prizes.length > 0)
         {
            select(var_686[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_2099) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1311) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         var_855.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
