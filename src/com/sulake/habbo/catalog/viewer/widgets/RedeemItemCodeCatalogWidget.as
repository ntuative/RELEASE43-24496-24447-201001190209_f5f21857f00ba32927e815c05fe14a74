package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1025:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         if(var_1025 != null)
         {
            var_1025.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1024 != null)
         {
            var_1024.removeEventListener(WindowKeyboardEvent.const_111,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1025 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1025 != null)
         {
            var_1025.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1024 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1024 != null)
         {
            var_1024.addEventListener(WindowKeyboardEvent.const_111,windowKeyEventProcessor);
         }
      }
