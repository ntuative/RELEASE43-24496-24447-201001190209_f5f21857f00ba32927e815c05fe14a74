package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1276:IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1111.text = "${" + _loc3_.name + "}";
            var_1112.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1111.text = "${" + _loc2_.localizationId + "}";
            var_1112.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_383:
                  _loc4_ = var_1277.clone();
                  if(var_572 != null)
                  {
                     var_572.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_572,var_1276,var_1311);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_206:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_303,AvatarAction.const_575);
      ...
      {
         var_1111 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1112 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_92 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1496 = new Point(var_92.x,var_92.y);
         var_572 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1276 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_572 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         var_1311 = _loc1_.content as XML;
         var _loc2_:BitmapDataAsset = page.viewer.catalog.assets.getAssetByName("ctlg_dyndeal_background") as BitmapDataAsset;
         var_1277 = _loc2_.content as BitmapData;
