package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_579[var_1036] as Array;
      ...
      {
         var _loc2_:Offer = var_579[var_1036][var_2167];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_410 || _loc1_.pricingModel == Offer.const_356)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc3_.productType == ProductTypeEnum.const_77 || _loc3_.productType == ProductTypeEnum.const_75)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        if(var_1035.indexOf(_loc5_) == -1)
                        {
                           var_1035.push(_loc5_);
                           var_579.push(new Array());
                        }
                        _loc6_ = var_1035.indexOf(_loc5_);
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_579)
         {
            if(var_2167 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_2167] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_1036 = var_882.getGridItemIndex(param1.view);
