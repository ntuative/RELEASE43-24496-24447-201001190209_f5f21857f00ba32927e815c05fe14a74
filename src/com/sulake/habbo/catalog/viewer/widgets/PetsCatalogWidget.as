package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_398 >= var_294.length)
         {
            return "";
         }
         var petColor:IPetColor = var_294[var_398] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_547[var_1429] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         if(var_398 < 0 || var_398 > var_294.length)
         {
            var_398 = 0;
         }
         updateImage();
      ...
      private function onApproveNameResult(param1:CatalogWidgetApproveNameResultEvent) : void
      {
         ...
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_903.getWithIndex(0),page,p);
      }
      ...
      override public function init() : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_153,onTextWindowEvent);
         var_903 = new Map();
         ...
         var_814 = getPetTypeIndexFromProduct(_loc5_.localizationId);
         var_294 = [];
         var_547 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc11_ = _loc10_.avatarRenderManager.petDataManager.getPetData(var_814);
               if(_loc11_)
               {
                  var_547 = _loc11_.breeds;
         ...
         var _loc6_:int = 0;
         while(_loc6_ < var_547.length)
         {
            _loc12_ = var_547[_loc6_] as IBreed;
            _loc3_.push(_loc4_.getKey(getRaceLocalizationKey(var_814,_loc12_.id),getRaceLocalizationKey(var_814,_loc12_.id)));
            _loc6_++;
         }
         var_903.add(var_814,_loc5_);
         ...
         events.addEventListener(WidgetEvent.const_984,onApproveNameResult);
         _loc5_ = var_903.getWithIndex(0);
         if(_loc5_ != null)
         {
      ...
      {
         var _loc7_:* = null;
         var _loc1_:Offer = var_903.getWithIndex(0);
         if(_loc1_ == null)
         {
            return;
         }
         ...
         if(var_398 >= 0 && var_398 < var_294.length)
         {
            _loc7_ = var_294[var_398] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_547[var_1429] as IBreed;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImageNew(var_814,_loc3_.id,_loc2_,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_303,AvatarAction.const_577);
