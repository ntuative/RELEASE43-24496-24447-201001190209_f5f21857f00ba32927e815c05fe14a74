package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_215:IMarketPlace;
      ...
      private var var_334:ICatalogViewer;
      ...
      private var var_1780:GiftWrappingConfiguration;
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_1779 && var_736 != null)
         {
            var_736.playSound(HabboSoundTypesEnum.const_912);
         }
         var_1779 = false;
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_86:
               var_1133 = param1.session.isPrivateRoom;
               if(var_87 != null)
               {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_1780 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         {
            var_202.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function createMarketPlace() : void
      {
         if(var_215 == null)
         {
            var_215 = new MarketPlaceLogic(this,_windowManager);
         }
      }
      ...
      {
         var_202.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_107,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_1778 && var_736 != null)
         {
            var_736.playSound(HabboSoundTypesEnum.const_923);
         }
         var_1778 = false;
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_334 = new CatalogViewer(this,_loc1_,_roomEngine) as ICatalogViewer;
      }
