package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1609:uint = 4.291613146E9;
      ...
      private const const_1610:int = 10;
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_839;
               }
            }
            _loc4_++;
         }
      ...
      {
         if(this.var_160 == null || this.var_160.offerId != param1.offerId)
         {
            return;
         }
      ...
      private function updateLocalizations() : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc1_:IProductData = var_90.getProductData(var_160.localizationId);
         ...
         switch(var_160.priceType)
         {
            ...
            case Offer.const_469:
               ...
               _loc5_ = _localization.getLocalization(_loc6_);
               _localization.registerParameter(_loc6_,"credits",var_160.priceInCredits.toString());
               _localization.registerParameter(_loc6_,"pixels",var_160.priceInPixels.toString());
               _loc3_ = _loc5_.value;
               _localization.registerParameter(_loc6_,"credits",_loc7_);
      ...
      private function updatePreview() : void
      {
         ...
         var _loc2_:IRoomEngine = var_160.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(var_839,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = var_1325;
         for each(_loc6_ in _loc3_)
         {
            _loc4_ = var_90.getFurnitureData(_loc6_,ProductTypeEnum.const_75);
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               var_90.purchaseProduct(var_637,var_160,var_1013);
               dispose();
               break;
            case "cancel_button":
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_839);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_561[var_204]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_560[var_205]);
         var_90.purchaseProductAsGift(var_637,var_160,var_1013,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_51:
               ...
               break;
            case WindowKeyboardEvent.const_667:
      ...
      private function showConfirmationDialog() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc3_ = var_90.getProductData(var_160.localizationId);
            _loc1_.text = _loc3_ == null ? "" : _loc3_.name;
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByName("product_image") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc4_ = var_160.page.viewer.roomEngine;
            _loc6_ = var_160.productContainer.firstProduct;
