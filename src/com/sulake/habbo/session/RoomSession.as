package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_897:UserDataManager;
      ...
      {
         if(_state == RoomSessionEvent.const_290 && _connection != null)
         {
      ...
      {
         return var_897 as IUserDataManager;
      }
