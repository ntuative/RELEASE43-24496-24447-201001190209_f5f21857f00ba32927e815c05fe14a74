   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_34 != null)
         {
            ...
            var_34.events.removeEventListener(RoomSessionEvent.const_95,roomSessionEventHandler);
            var_34.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_368,roomSessionEventHandler);
      ...
      {
         return EffectsModel(var_54.getValue(InventoryCategory.const_622));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_54.getValue(InventoryCategory.const_72));
      }
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_942));
      }
      
      public function get petsModel() : PetsModel
      {
         return PetsModel(var_54.getValue(InventoryCategory.const_172));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1606);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_54.getValue(InventoryCategory.const_291));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_794.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_794.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_54.getValue(InventorySubCategory.const_228));
      }
      ...
      {
         return var_54.getValue(InventoryCategory.const_455) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1415 = new IncomingMessages(this);
      ...
      {
         return BadgesModel(var_54.getValue(InventoryCategory.const_247));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_34.events.addEventListener(RoomSessionEvent.const_95,roomSessionEventHandler);
         var_34.events.addEventListener(RoomSessionPropertyUpdateEvent.const_368,roomSessionEventHandler);
         ...
         var_54.add(InventoryCategory.const_455,_loc3_);
         ...
         var_54.add(InventoryCategory.const_172,_loc10_);
