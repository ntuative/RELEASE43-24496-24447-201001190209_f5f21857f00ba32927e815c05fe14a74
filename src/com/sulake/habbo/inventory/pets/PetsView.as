package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_439 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      private function selectFirst() : void
      {
         ...
         setSelectedGridItem(var_539.getWithIndex(0));
      }
      ...
      {
         var _loc2_:PetsGridItem = var_539.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_439.removeGridItem(_loc2_.window);
         if(var_292 == _loc2_)
         {
            var_292 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_539.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_439.addGridItem(_loc2_.window);
            var_539.add(param1.id,_loc2_);
            if(var_292 == null)
            {
               selectFirst();
            }
