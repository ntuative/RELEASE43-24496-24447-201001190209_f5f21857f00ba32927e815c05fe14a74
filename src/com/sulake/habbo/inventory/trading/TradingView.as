   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_918)
            {
            ...
            var_352.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_415);
            var_352.show();
         }
      ...
      {
         var _loc2_:ITextWindow = var_69.findChildByName("info_text_1") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
         var _loc3_:IItemGridWindow = var_69.findChildByName("item_grid_1") as IItemGridWindow;
         if(_loc3_)
         {
      ...
      {
         return var_69.findChildByTag("OWN_USER_GRID") as IItemGridWindow;
      }
      ...
      {
         var _loc2_:ITextWindow = var_69.findChildByName("info_text_0") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
         var _loc3_:IItemGridWindow = var_69.findChildByName("item_grid_0") as IItemGridWindow;
         if(_loc3_)
         {
            _loc3_.visible = false;
         }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         if(var_69 == null)
         {
            var_69 = createNormalWindow();
         }
         if(var_1487 == null)
         {
            var_1487 = createMinimizedWindow();
         }
         if(!var_2125)
         {
            return var_69;
      ...
      {
         var _loc2_:ITextWindow = var_69.findChildByName("help_text") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
      }
      ...
      {
         var _loc1_:ITextWindow = var_69.findChildByName("info_text_0") as ITextWindow;
         _loc1_.visible = false;
         var _loc2_:IItemGridWindow = var_69.findChildByName("item_grid_0") as IItemGridWindow;
         if(_loc2_)
         {
            _loc2_.visible = true;
         }
      ...
      {
         var _loc1_:ITextWindow = var_69.findChildByName("info_text_1") as ITextWindow;
         _loc1_.visible = false;
         var _loc2_:IItemGridWindow = var_69.findChildByName("item_grid_1") as IItemGridWindow;
         if(_loc2_)
         {
            _loc2_.visible = true;
         }
      ...
      public function updateUserInterface() : void
      {
         ...
         {
            updateActionState();
            _loc2_ = var_69.findChildByTag("OTHER_USER_NAME") as ITextWindow;
            if(_loc2_)
            {
               _loc2_.text = var_37.otherUserName;
            }
            _loc1_ = var_69.findChildByTag("OWN_USER_BORDER");
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_773) : uint(const_774);
            }
            _loc3_ = var_69.findChildByTag("OWN_USER_LOCK") as IBitmapWrapperWindow;
            if(_loc3_)
            {
            ...
            _loc1_ = var_69.findChildByTag("OTHER_USER_BORDER");
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_773) : uint(const_774);
            }
            _loc3_ = var_69.findChildByTag("OTHER_USER_LOCK") as IBitmapWrapperWindow;
            if(_loc3_)
            {
               if(_loc3_.bitmap == null)
               {
      ...
      {
         return var_69.findChildByTag("OTHER_USER_GRID") as IItemGridWindow;
      }
      ...
      public function updateActionState() : void
      {
         ...
         if(var_69)
         {
            _loc1_ = var_69.findChildByName("button_accept");
            if(!_loc1_)
            {
               return;
            }
